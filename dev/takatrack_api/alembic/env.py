...
from app.models import Design, Transaction  # noqa: E402, F401

target_metadata = Base.metadata

# ---------------------------------------------------------------------------
# Override sqlalchemy.url from the environment (takes precedence over alembic.ini)
# ---------------------------------------------------------------------------
...
def run_migrations_offline() -> None:
    ...
    Configures the context with just a URL and not an Engine, then calls
    context.execute() to emit DDL as SQL text.
    """
...
def run_migrations_online() -> None:
    ...
    invokes the migration function.
    """
